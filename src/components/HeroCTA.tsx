  ...
  return (
    <div className="flex flex-col items-center justify-center pt-25">
      ...
      >
        ...
        <motion.span variants={child} style={{ display: "inline-block" }}>
          <span className="bg-clip-text text-transparent bg-linear-to-r from-cyan-500 to-pink-600">
            Fearlessly,
          </span>
        </motion.span>
        <br />
      ...
      {/* Animated Button */}
      <motion.div
        className="flex rounded-lg h-10 px-3 font-medium items-center justify-center p-px mt-8"
